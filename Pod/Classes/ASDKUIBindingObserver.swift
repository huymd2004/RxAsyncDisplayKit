 ...
 * binding does not necessarily have to be done on main thread
 ...
 */
public class ASDKUIBindingObserver<UIElementType, Value where UIElementType: AnyObject> : ObserverType {
    ...
    public func on(event: Event<Value>) {
        // FIXME: may be not including this is correct? as ASDK can be run on background thread???
